...
mesh = pipeline_shapegen(image=image, num_inference_steps=50, guidance_scale=10.0, extra_cond_tok=cond_tok, classifier_scale=0.0, octree_resolution=256, append_extra_cond_tok=append_cond_tok)[0]
